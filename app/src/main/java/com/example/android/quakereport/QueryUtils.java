...
public final class QueryUtils
{
    ...
    public static List<earthquakedata> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i = 0; i<earthquakeArray.length();i++)
            {
                ...
                String place = properties.getString("place"); // Extract the value for the key called "place"
                ...
                earthquakedata data = new earthquakedata(mag, place, time, url);
    ...
    public static List<earthquakedata> fetchEarthquakeData(String requestUrl)
    {
        ...
        {
            Log.e(LOG_TAG, "Problem making HTTP request.", ex);
            ex.printStackTrace();
        }
        ...
        //Return the list of{@link earthquakedata}
        return earthquakes;
    ...
    private static URL createUrl(String stringUrl)
    {
        ...
        {
            Log.e(LOG_TAG,"Problem building the URL", ex);
        }
        return url;
    }
    /**------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        // If the URL is null, then just return early.
        if (url == null) {
            return jsonResponse;
        }
